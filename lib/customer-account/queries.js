...
// Only the trade discount's minimum-order-quantity metafield is exposed to the
// Customer Account API (see custom.min_order_quantity's access settings) — the
// discount_percent metafield deliberately isn't, so a business's negotiated rate
// never leaks to the storefront. This lets the cart show "N more items to unlock
// your trade discount" without ever exposing the rate itself.
export const TRADE_DISCOUNT_THRESHOLD_QUERY = `#graphql
  query TradeDiscountThreshold {
    customer {
